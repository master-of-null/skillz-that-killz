...
1. **Introduce:** Briefly explain the brief → spec transformation
...
4. **Generate spec:**
   - Read template: `$HOME/.agents/templates/tech-spec-template.md`
...
7. **Next steps:**
   - "Ready for Developer. Begin implementation? Ask Codex to implement the spec."

## TODO Composition

Use the available plan tool or a Markdown checklist when useful:

1. `spec-introduce` - "Explain the brief → spec transformation"
