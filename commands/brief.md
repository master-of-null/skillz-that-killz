...
1. **Introduce:** Briefly explain the brief creation process
...
3. **Generate brief:**
   - Read template: `$HOME/.agents/templates/product-brief-template.md`
...
5. **Next steps:**
   - "Ready for Architect. Create spec? Use `/prompts:spec` with the brief path."

## TODO Composition

Use the available plan tool or a Markdown checklist when useful:

1. `brief-introduce` - "Explain the brief creation process"
