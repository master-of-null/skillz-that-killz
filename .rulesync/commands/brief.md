...
**Persona:** `@product-owner` (Paige, Product Owner). Load `$HOME/.rulesync/subagents/product-owner.md`.
...
3. **Generate brief:**
   - Read template: `$HOME/.rulesync/templates/product-brief-template.md`
